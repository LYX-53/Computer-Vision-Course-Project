...
class Trainer:
    ...
    def __init__(
            ...
            *,
            ...
            train_lr: float = 0.001,  # Learning rate for the optimizer
            train_num_steps: int = 2000,  # Number of training steps
            ...
            step_start_ema: int = 200,  # Step at which to start EMA
            update_ema_every: int = 10,  # Frequency to update EMA
            save_model_every: int = 100,  # Frequency to save the model
        ...
        self.dl = cycle(
            torch.utils.data.DataLoader(self.ds, batch_size=train_batch_size, shuffle=True, pin_memory=True))
    ...
    def train(
        ...
        while self.step < self.train_num_steps:
            ...
            if self.step >= self.train_num_steps:
                print("Reached maximum training steps. Stopping.")
                break
