...
class Trainer:
    ...
    def __init__(
            ...
            *,
            ...
            train_batch_size: int = 2,  # Batch size for training
            train_lr: float = 0.0001,  # Learning rate for the optimizer
            train_num_steps: int = 15000,  # Number of training steps
            ...
            save_model_every: int = 500,  # Frequency to save the model
